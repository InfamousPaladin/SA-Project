...
NUITKA_CROSS_MODULE PyObject *impl___main__$$$function__12_complex_call_helper_keywords_star_list_star_dict(PyThreadState *tstate, PyObject **python_pars);
...
static PyObject *impl_numpy$core$_methods$$$function__10__clip_dep_invoke_with_casting(PyThreadState *tstate, struct Nuitka_FunctionObject const *self, PyObject **python_pars) {
    ...
    branch_yes_1:;
    {
...

        {
            ...
            tmp_return_value = impl___main__$$$function__12_complex_call_helper_keywords_star_list_star_dict(tstate, dir_call_args);
        }
        if (tmp_return_value == NULL) {
            assert(HAS_ERROR_OCCURRED(tstate));
